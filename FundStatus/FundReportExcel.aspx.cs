namespace GSA.OpenItems.Web
{
    ...
    public partial class FundReportExcel : PageBase
    {
        ...
        private void FundsEntryDataReport()
        {
            ...
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCellLeft(sTitle, "title", 9));
            Sheet.Rows.Add(tr);

            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("", "", 9));
            Sheet.Rows.Add(tr);

            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell(Organization, "title2", 2));
            tr.Cells.Add(CreateCell(String.Format("{0:MMMM}", DateTime.Parse(BookMonth + "/" + FiscalYear)), "title2", 2));
            tr.Cells.Add(CreateCellLeft("Fiscal Year: " + FiscalYear, "title2", 5));
            Sheet.Rows.Add(tr);
            ...
            if (dst != null && dst.Tables[0] != null && dst.Tables[0].Rows.Count > 0)
            {
                ...
                if (dr_col.Length > 0)
                    td = CreateCell(dr_col[0]["Name"].ToString(), "title2", 2);
            }
            if (td == null)
                td = CreateCell("", "title2", 2);
            tr.Cells.Add(td);
            tr.Cells.Add(CreateCell("", "title2", 2));
            tr.Cells.Add(CreateCellLeft("", "title2", 5));
            Sheet.Rows.Add(tr);
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCell(String.Format("Last updated by {0} on {1}.", user_name, update_date), "reportCaption", 9));
                Sheet.Rows.Add(tr);
            }
            ...
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("BookMonth", "reportHeaderBlue", 2));
            tr.Cells.Add(CreateCell("DocNumber", "reportHeaderBlue", 2));
            tr.Cells.Add(CreateCell("$ Amount", "reportHeaderBlue", 1));
            tr.Cells.Add(CreateCell("Explanation", "reportHeaderBlue", 4));
            Sheet.Rows.Add(tr);
            ...
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCell(entry_month, "extRow", 2));
                tr.Cells.Add(CreateCell(doc_number, "extRow", 2));
                tr.Cells.Add(CreateCell((Convert.ToInt64(amount)).ToString(), "ExtNumber", 1));
                tr.Cells.Add(CreateCell(explanation, "extRow", 4));
                Sheet.Rows.Add(tr);
                if (entry_id < 0)   //expanded table
                {
                    ...
                    if (dt == null || dt.Columns.Count == 0)
                        continue;
                    tr = new HtmlTableRow();
                    tr.Cells.Add(CreateCell("", "", 1));
                    for (var i = 0; i < dt.Columns.Count; i++)
                    {
                        tr.Cells.Add(CreateCell(dt.Columns[i].ToString(), "reportHeaderGreen", 1));
                    }
                    Sheet.Rows.Add(tr);
                    foreach (DataRow r in dt.Rows)
                    {
                        ...
                        for (var i = 0; i < dt.Columns.Count; i++)
                        {
                            if (dt.Columns[i].ColumnName == "$ Amount")
                                tr.Cells.Add(CreateCell((Convert.ToInt64(r["$ Amount"])).ToString(), "IntNumber", ""));
                            else
                                tr.Cells.Add(CreateCell(r[i].ToString(), "intRow", 1));
                        }
                        Sheet.Rows.Add(tr);
                    }
                }
        ...
        private void BuildAllowanceReportTable()
        {
            ...
            var dt = FundAllowance.GetDetailedAllowanceForFiscalYear(FY).Tables[0];
        ...
        private void BuildFundsSearchTable()
        {
            ...
            //start Excel headers:
            var tr = new HtmlTableRow();
            tr.Cells.Add(CreateCellLeft("Funds Search Results", "title", 14));
            Sheet.Rows.Add(tr);
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCellLeft(title_text, "title2", 14));
            Sheet.Rows.Add(tr);

            //display query parameters in Excel:
            if (business_line != "")
            {
                var ds_t = FundStatus.GetBusinessLineList();
                if (ds_t != null && ds_t.Tables[0] != null && ds_t.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (dr_col.Length > 0)
                    {
                        ...
                        tr = new HtmlTableRow();
                        tr.Cells.Add(CreateCellLeft("Business Line:", "reportCaption2", 2));
                        tr.Cells.Add(CreateCellLeft(bl_name, "title2", 12));
                        Sheet.Rows.Add(tr);
                    }
                }
            }
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCellLeft("Organization:", "reportCaption2", 2));
            tr.Cells.Add(CreateCellLeft(organization, "title2", 12));
            Sheet.Rows.Add(tr);
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCellLeft("Fiscal Year:", "reportCaption2", 2));
            tr.Cells.Add(CreateCellLeft(fiscal_year, "title2", 12));
            Sheet.Rows.Add(tr);
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCellLeft("Book Month:", "reportCaption2", 2));
            if (book_month == "")
                tr.Cells.Add(CreateCellLeft("All Available", "title2", 12));
            else
            {
                var s = "";
                ...
                tr.Cells.Add(CreateCellLeft(s, "title2", 12));
            }
            Sheet.Rows.Add(tr);
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCellLeft("Budget Activity:", "reportCaption2", 2));
            tr.Cells.Add(CreateCellLeft(BudgetActivity, "title2", 12));
            Sheet.Rows.Add(tr);
            ...
            if (group_cd != null && group_cd != "")
            {
                ...
                if (ds_g != null && ds_g.Tables[0] != null && ds_g.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (dr_col.Length > 0)
                    {
                        ...
                        tr = new HtmlTableRow();
                        tr.Cells.Add(CreateCellLeft("Filter by Function Report Group:", "reportCaption2", 2));
                        tr.Cells.Add(CreateCellLeft(group_name, "tableBold", 12));
                        Sheet.Rows.Add(tr);
                    }
                }
            }
            ...
            {
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCellLeft("Filter by Functions:", "reportCaption2", 2));
                tr.Cells.Add(CreateCellLeft(summary_function, "tableBold", 12));
                Sheet.Rows.Add(tr);
            }
            if (oc_code != null && oc_code != "")
            {
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCellLeft("Filter by OC Code:", "reportCaption2", 2));
                tr.Cells.Add(CreateCellLeft(oc_code, "tableBold", 12));
                Sheet.Rows.Add(tr);
            }
            if (CostElem != null && CostElem != "")
            {
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCellLeft("Filter by Cost Elements:", "reportCaption2", 2));
                tr.Cells.Add(CreateCellLeft(CostElem, "tableBold", 12));
                Sheet.Rows.Add(tr);
            }
            if (doc_number != "")
            {
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCellLeft("DocNumber like:", "reportCaption2", 2));
                tr.Cells.Add(CreateCellLeft(doc_number, "tableBold", 12));
                Sheet.Rows.Add(tr);
            }

            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("", "", 14));
            Sheet.Rows.Add(tr);
            ...
            var ds = FundStatus.GetSearchResults(obl_income_view, fiscal_year, BudgetActivity, out records, out total_amount,
                obj_org_code, obj_book_month, obj_group_cd, obj_sum_func, obj_oc_code, obj_CE, obj_doc_num, Int32.Parse(ConfigurationManager.AppSettings["QueryResultMaxRecords"]), false);

            if (ds == null || records == 0)
            {
                //no records:
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCellLeft("No records found", "reportCaption", 14));
                Sheet.Rows.Add(tr);
                p_iHeaderLines = 0;
            }
            else
        ...
        private void BuildFundsReviewTable()
        {
            ...
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("Funds Review", "title", CELL_ALIGN_LEFT));
            Sheet.Rows.Add(tr);
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell(title_text, "title2", CELL_ALIGN_LEFT));
            Sheet.Rows.Add(tr);
            ...
            {
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCell("Business Line:", "reportCaption2", CELL_ALIGN_LEFT));
                tr.Cells.Add(CreateCell(business_line, "title2", CELL_ALIGN_RIGHT));
                Sheet.Rows.Add(tr);
            }
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("Organization:", "reportCaption2", CELL_ALIGN_LEFT));
            tr.Cells.Add(CreateCell(organization, "title2", CELL_ALIGN_RIGHT));
            Sheet.Rows.Add(tr);
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("Fiscal Year:", "reportCaption2", CELL_ALIGN_LEFT));
            tr.Cells.Add(CreateCell(fiscal_year, "title2", CELL_ALIGN_RIGHT));
            Sheet.Rows.Add(tr);
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("Book Month:", "reportCaption2", CELL_ALIGN_LEFT));
            if (book_month == "00")
                tr.Cells.Add(CreateCell("All Available", "title2", CELL_ALIGN_RIGHT));
            else
                tr.Cells.Add(CreateCell(String.Format("{0:MMMM}", DateTime.Parse(book_month + "/" + fiscal_year)), "title2", CELL_ALIGN_RIGHT));
            Sheet.Rows.Add(tr);
            ...
            if (dsTotal == null || dsTotal.Tables[0].Rows.Count == 0)
            {
                ...
                /************************************/
                tr = new HtmlTableRow();
                tr.Cells.Add(CreateCell("No records found", "reportCaption2", CELL_ALIGN_LEFT));
                Sheet.Rows.Add(tr);
            }
            else
            {
        ...
        private void BuildSummaryProjectionReportTable()
        {
            ...
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("Fund Summary Projection Report", "title", CELL_ALIGN_LEFT));
            Sheet.Rows.Add(tr);
        ...
        private void CreateReportView(int ReportViewType, string ReportHeader, string LabelText)
        {
            ...
            Sheet.Rows.Add(tr);
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell(LabelText, "reportCaption2", CELL_ALIGN_LEFT));
            Sheet.Rows.Add(tr);
        ...
        private void BuildStatusReportTable()
        {
            ...
            tr = new HtmlTableRow();
            tr.Cells.Add(CreateCell("Fund Status Report", "title", CELL_ALIGN_LEFT));
            Sheet.Rows.Add(tr);
        ...
        private void BuildGeneralExcelOutput(DataTable dt)
        {
            ...
            for (var i = 0; i < dt.Columns.Count; i++)
                objRow.Cells.Add(CreateCell(dt.Columns[i].ToString(), "tableCaption", ""));
