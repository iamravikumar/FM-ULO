    ...
    public partial class Allowance : PageBase
    {
        ...
        protected void btnSave_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                var dt = FundStatus.GetOrganizationList().Tables[0];
        ...
        {
            var ds = FundAllowance.GetDetailedAllowanceForFiscalYear(FiscalYear);
            ...
            ds = FundAllowance.GetAllowanceHistory(FiscalYear, HistoryActions.haAddNewAllowanceAmount,
        ...
        private void InitControls()
        {
            if (Page.User.IsInRole(((int)UserRoles.urFSBDAdminAllowanceWR).ToString()))
                btnSave.Attributes.Add("onclick", "return save_changes()");
            else
                tblButtons.Visible = false;
