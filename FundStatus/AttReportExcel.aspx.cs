...
namespace GSA.OpenItems.Web
{
    ...
    public partial class FundStatus_AttReportExcel : PageBase
    {
        ...
        private void BuildFundsSearchTable(int EmailRequestID)
        {
            ...
            tr.Cells.Add(CreateCellLeft(budget_activity, "title2", 12));
            Sheet.Rows.Add(tr);
            ...
            var ds = FundStatus.GetSearchResults(obl_income_view, fiscal_year, budget_activity, out records, out total_amount,
                obj_org_code, obj_book_month, obj_group_cd, obj_sum_func, obj_oc_code, obj_CE, obj_doc_num, Int32.Parse(ConfigurationManager.AppSettings["QueryResultMaxRecords"]), true);
