...
#region PrivateProperties
        ...
        private void DrawTable()
        {
            ...
            //tblData.Rows[0].Cells[0].Attributes.Add("style", "display:none;");                
            ...
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                tr = new HtmlTableRow();
                tr.Attributes.Add("class", (iRowCount++) % 2 > 0 ? "tRowAlt" : "tRow");
                if (entry_id >= 0 && !read_only && dr["BookMonth"].ToString() == BookMonth)
                {
                    ...
                    btnEdit.Attributes.Add("onclick", "return edit_row(this," + entry_id.ToString() + "," + DataEntryType.ToString() + ");");
                    ...
                    btnDelete.Attributes.Add("onclick", "return delete_row(this," + entry_id.ToString() + "," + DataEntryType.ToString() + ");");
                ...
                if (entry_id < 0)
                {
                    ...
                    td.Attributes.Add("onclick", "Expand(this)");
                    td.Attributes.Add("title", "Expand");
            ...
            if (!read_only)
            {
                ...
                btnCancel.Attributes.Add("width", "12px");
                btnCancel.Attributes.Add("height", "12px");
                btnCancel.Attributes.Add("onclick", "return cancel_edit(this);");
                ...
                btnEdit.Attributes.Add("width", "12px");
                btnEdit.Attributes.Add("height", "12px");
                btnEdit.Attributes.Add("onclick", "return save_row(this,0," + DataEntryType.ToString() + ");");
                td.Controls.Add(btnEdit);
                tr.Cells.Add(td);

                td = new HtmlTableCell();
                td.Attributes.Add("style", "padding-left:5px;padding-right:5px");
                txt = new HtmlInputText();
                txt.Attributes.Add("style", "width:100%;height:15px;text-align:center;");
                td.Controls.Add(txt);
                tr.Cells.Add(td);
                ...
                txt = new HtmlInputText();
                txt.Attributes.Add("style", "width:100%;height:15px;text-align:center;");
                txt.Attributes.Add("onmouseout", "extractNumber(this,0,true,9999999999);");
                txt.Attributes.Add("onkeyup", "extractNumber(this,0,true,9999999999);");
                txt.Attributes.Add("onkeypress", "return blockNonNumbers(this,event,false,true);");
                td.Controls.Add(txt);
                tr.Cells.Add(td);
