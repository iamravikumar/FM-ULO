...
Generation Time: 03/19/2020 15:59:58
*/
...
namespace GSA.UnliquidatedObligations.BusinessLayer.Data
{
    public partial class UloDbContext
    {
		...
		public async Task<ConnectionHelpers.Result> SoftDeleteAsync(string tableKey = null, string entityKey = null, string deletorId = null,  TimeSpan? commandTimeout=null) 
		{
            var ps = new SqlParameter[]
                {
                    new SqlParameter("@tableKey", tableKey==null ? DBNull.Value:(object) tableKey){Direction=ParameterDirection.Input, Size=100},
                    new SqlParameter("@entityKey", entityKey==null ? DBNull.Value:(object) entityKey){Direction=ParameterDirection.Input, Size=100},
                    new SqlParameter("@deletorId", deletorId==null ? DBNull.Value:(object) deletorId){Direction=ParameterDirection.Input, Size=128},
                };
            var conn = Database.GetDbConnection();
            await EnsureConnectedAsync(conn);
            return await conn.ExecuteNonQueryAsync(null, "dbo.SoftDelete", commandTimeout, ps);
		}
	...
	public partial class EmailTemplate : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		[Column("EmailBody", TypeName="varchar(max)")]
		public string EmailBody { get; set; } 	

		[DisplayName("Email Subject")]
		[Display(Name = "Email Subject")]
		[Column("EmailSubject", TypeName="varchar(max)")]
