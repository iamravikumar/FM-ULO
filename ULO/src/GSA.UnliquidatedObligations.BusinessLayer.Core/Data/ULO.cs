...
Generation Time: 06/17/2019 17:57:37
*/
...
namespace GSA.UnliquidatedObligations.BusinessLayer.Data
{
    public partial class UloDbContext
    {
		...
		public async Task<ConnectionHelpers.Result> GetUloSummariesByPdnAsync(string pegasysDocumentNumber = null) 
		{
            ...
            return await conn.ExecuteNonQueryAsync(null, "dbo.GetUloSummariesByPdn", null, ps);
		}
	...
	public partial class Region : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		//modelBuilder.Entity<Review>(e=>e.HasOne(r=>r.Region).WithMany(u=>u.RegionReviews).HasForeignKey(r=>r.RegionId));
		[InverseProperty("Region")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<Review> RegionReviews { get; set; } = new List<Review>();
		...
		public Region(Region other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				RegionReviews = other.RegionReviews;
				RegionReviews = other.RegionReviews;
