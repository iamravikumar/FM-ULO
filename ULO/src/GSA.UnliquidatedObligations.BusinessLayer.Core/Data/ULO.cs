...
XML File: C:\Users\jason\Source\Repos\FM-ULO\ULO\src\GSA.UnliquidatedObligations.BusinessLayer.Core\Data\ULO.xml
Generation Time: 01/06/2019 21:24:48
*/
...
namespace GSA.UnliquidatedObligations.BusinessLayer.Data
{
    public partial class UloDbContext
    {
		...
		public DbQuery<ApplicationUser> ApplicationUsers { get; set; } //dbo.ApplicationUsers

		
		public DbSet<AspNetRole> AspNetRoles { get; set; } //dbo.AspNetRoles

		
		public DbSet<AspNetUser> AspNetUsers { get; set; } //dbo.AspNetUsers

		
		public DbQuery<AspnetUserApplicationPermissionClaim> AspnetUserApplicationPermissionClaims { get; set; } //dbo.AspnetUserApplicationPermissionClaims

		
		public DbSet<AspNetUserClaim> AspNetUserClaims { get; set; } //dbo.AspNetUserClaims

		
		public DbSet<AspNetUserLogin> AspNetUserLogins { get; set; } //dbo.AspNetUserLogins

		
		public DbSet<AspNetUserRole> AspNetUserRoles { get; set; } //dbo.AspNetUserRoles

		
		public DbQuery<AspnetUserSubjectCategoryClaim> AspnetUserSubjectCategoryClaims { get; set; } //dbo.AspnetUserSubjectCategoryClaims

		
		public DbSet<Attachment> Attachments { get; set; } //dbo.Attachments

		
		public DbQuery<CardholderDocumentMap> CardholderDocumentMap { get; set; } //dbo.CardholderDocumentMap

		
		public DbSet<Document> Documents { get; set; } //dbo.Documents

		
		public DbSet<DocumentDocumentType> DocumentDocumentTypes { get; set; } //dbo.DocumentDocumentTypes

		
		public DbSet<DocumentType> DocumentTypes { get; set; } //dbo.DocumentTypes

		
		public DbSet<EmailTemplate> EmailTemplates { get; set; } //dbo.EmailTemplates

		
		public DbQuery<FiscalMonthMapping> FiscalMonthMapping { get; set; } //dbo.FiscalMonthMapping

		
		public DbQuery<MostRecentWorkflowView> MostRecentWorkflowViews { get; set; } //dbo.MostRecentWorkflowViews

		
		public DbSet<Note> Notes { get; set; } //dbo.Notes

		
		public DbSet<PdnAttribute> PdnAttributes { get; set; } //dbo.PdnAttributes

		
		public DbSet<ReportDefinition> ReportDefinitions { get; set; } //dbo.ReportDefinitions

		
		public DbSet<RequestForReassignment> RequestForReassignment { get; set; } //dbo.RequestForReassignment

		
		public DbSet<Review> Reviews { get; set; } //dbo.Reviews

		
		public DbQuery<ReviewStat> ReviewStats { get; set; } //dbo.ReviewStats

		
		public DbSet<SemiAnnualSamplingStat> SemiAnnualSamplingStats { get; set; } //dbo.SemiAnnualSamplingStats

		
		public DbSet<UnliqudatedObjectsWorkflowQuestion> UnliqudatedObjectsWorkflowQuestions { get; set; } //dbo.UnliqudatedObjectsWorkflowQuestions

		
		public DbSet<UnliquidatedObligation> UnliquidatedObligations { get; set; } //dbo.UnliquidatedObligations

		
		public DbSet<UserUser> UserUsers { get; set; } //dbo.UserUsers

		
		public DbSet<Workflow> Workflows { get; set; } //dbo.Workflows

		
		public DbQuery<WorkflowActivity> WorkflowActivities { get; set; } //dbo.WorkflowActivities

		
		public DbSet<WorkflowDefinition> WorkflowDefinitions { get; set; } //dbo.WorkflowDefinitions

		
		public DbSet<WorkflowHistory> WorkflowHistory { get; set; } //dbo.WorkflowHistory

		
		public DbQuery<WorkflowJustification> WorkflowJustifications { get; set; } //dbo.WorkflowJustifications

		
		public DbQuery<WorkflowProhibitedOwner> WorkflowProhibitedOwners { get; set; } //dbo.WorkflowProhibitedOwners

		
		public DbSet<WorkflowView> WorkflowViews { get; set; } //dbo.WorkflowViews

		#endregion

		#region Sprocs

		public async Task<ConnectionHelpers.Result> ListableWorkflowsAsync(string ownerId = null, string viewerId = null) 
		{
            ...
            return await conn.ExecuteNonQueryAsync(null, "dbo.ListableWorkflows", null, ps);
		}
	...
	public partial class AspNetRole : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<string>
	{
        public static readonly AspNetRole[] None = new AspNetRole[0];


		//modelBuilder.Entity<AspNetUserRole>(e=>e.HasOne(r=>r.Role).WithMany(u=>u.RoleAspNetUserRoles).HasForeignKey(r=>r.RoleId));
		[InverseProperty("Role")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<AspNetUserRole> RoleAspNetUserRoles { get; set; } = new List<AspNetUserRole>();
		...
		public AspNetRole(AspNetRole other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				RoleAspNetUserRoles = other.RoleAspNetUserRoles;
				Name = other.Name;
			}
			OnConstructed();
		}
		...
		public virtual void Validate()
        {
			...
			Requires.Text(Name, nameof(Name), true, 0, 256);
			PartialValidate();
        }
	...
	public partial class AspNetUserClaim : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
	...
	public partial class AspNetUserLogin : IRdbDataEntity, IValidate, IPreSave
	{
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} LoginProvider={LoginProvider}ProviderKey={ProviderKey}UserId={UserId} {extras}";
		}
		...
		public virtual void Validate()
        {
			Requires.NonNull(LoginProvider, nameof(LoginProvider));
			Requires.Text(LoginProvider, nameof(LoginProvider), true, 0, 128);
			Requires.NonNull(ProviderKey, nameof(ProviderKey));
			Requires.Text(ProviderKey, nameof(ProviderKey), true, 0, 128);
			Requires.NonNull(UserId, nameof(UserId));
			Requires.Text(UserId, nameof(UserId), true, 0, 128);
			PartialValidate();
        }
	...
	public partial class AspNetUserRole : IRdbDataEntity, IValidate, IPreSave
	{
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} UserId={UserId}RoleId={RoleId} {extras}";
		}
		...
		public virtual void Validate()
        {
			Requires.NonNull(UserId, nameof(UserId));
			Requires.Text(UserId, nameof(UserId), true, 0, 128);
			Requires.NonNull(RoleId, nameof(RoleId));
			Requires.Text(RoleId, nameof(RoleId), true, 0, 128);
			PartialValidate();
        }
	}//end of entity class AspNetUserRole

	[Table("AspNetUsers", Schema = "dbo")]
	public partial class AspNetUser : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<string>
	{
		...
		//modelBuilder.Entity<AspNetUserRole>(e=>e.HasOne(r=>r.User).WithMany(u=>u.UserAspNetUserRoles).HasForeignKey(r=>r.UserId));
		[InverseProperty("User")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<AspNetUserRole> UserAspNetUserRoles { get; set; } = new List<AspNetUserRole>();
		...
		//modelBuilder.Entity<AspNetUserLogin>(e=>e.HasOne(r=>r.User).WithMany(u=>u.UserAspNetUserLogins).HasForeignKey(r=>r.UserId));
		[InverseProperty("User")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<AspNetUserLogin> UserAspNetUserLogins { get; set; } = new List<AspNetUserLogin>();
		...
		public AspNetUser(AspNetUser other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				UserAspNetUserRoles = other.UserAspNetUserRoles;
				DeletedByUserNotes = other.DeletedByUserNotes;
				UserAspNetUserClaims = other.UserAspNetUserClaims;
				UserAspNetUserLogins = other.UserAspNetUserLogins;
		...
		public virtual void Validate()
        {
			Requires.NonNull(Id, nameof(Id));
			Requires.Text(Id, nameof(Id), true, 0, 128);
			Requires.Text(Email, nameof(Email), true, 0, 256);
			Requires.NonNull(UserName, nameof(UserName));
			Requires.Text(UserName, nameof(UserName), true, 0, 256);
    ...
    public partial class UloDbContext
    {
        ...
        private void AddFluentKeys(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUserLogin>().HasKey(z => new {z.LoginProvider, z.ProviderKey, z.UserId });
            modelBuilder.Entity<AspNetUserRole>().HasKey(z => new {z.UserId, z.RoleId });
        }
