...
Generation Time: 01/21/2019 09:24:45
*/
...
namespace GSA.UnliquidatedObligations.BusinessLayer.Data
{
    public partial class UloDbContext
    {
		...
		public DbSet<AspNetRoleClaim> AspNetRoleClaims { get; set; } //dbo.AspNetRoleClaims
		...
		public DbSet<AspNetUserToken> AspNetUserTokens { get; set; } //dbo.AspNetUserTokens
	...
	public partial class AspNetRole : IdentityRole, IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<string>
	{
		...
		//modelBuilder.Entity<AspNetRoleClaim>(e=>e.HasOne(r=>r.Role).WithMany(u=>u.RoleAspNetRoleClaims).HasForeignKey(r=>r.RoleId));
		[InverseProperty("Role")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<AspNetRoleClaim> RoleAspNetRoleClaims { get; set; } = new List<AspNetRoleClaim>();
		...
		public AspNetRole(AspNetRole other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				RoleAspNetRoleClaims = other.RoleAspNetRoleClaims;
			}
			OnConstructed();
		}
	...
	public partial class AspNetUserToken : IdentityUserToken<string>, IRdbDataEntity, IValidate, IPreSave
	{
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} UserId={UserId}LoginProvider={LoginProvider}Name={Name} {extras}";
		}
		...
		public virtual void Validate()
        {
			...
			Requires.Text(LoginProvider, nameof(LoginProvider), true, 0, 450);
			Requires.NonNull(Name, nameof(Name));
			Requires.Text(Name, nameof(Name), true, 0, 450);
			PartialValidate();
        }
...
//            modelBuilder.Entity<AspNetUserToken>().HasKey(z => new {z.UserId, z.LoginProvider, z.Name });
        }
