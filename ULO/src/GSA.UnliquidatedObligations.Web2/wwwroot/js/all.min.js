...
/*! recordslisting.js */
/*! reviews.js */
$(document).ready(function(){showHideRegion();$("#ReviewScopeId").change(function(){showHideRegion()})});
/*! users.js */
$(document).ready(function(){$("#RegionId").change(function(){UsersRegionChanged(this.value)});addEditClick();addCreateClick();addNewUserSaveClick()});