...
function tt_Htm(tt, t_id, txt)
{
	...
	t_tits    = (typeof tt.T_TITLESIZE != tt_u)? tt.T_TITLESIZE : ttTitleSize,
	...
	if(t_tit)
	{
		t_y += '<tr><td style="padding-left:3px;padding-right:3px;" align="'+t_algn+'"><font color="'+t_titc+'" face="'+t_ff+'" ' +
			'style="color:'+t_titc+';font-family:'+t_ff+';font-size:'+t_tits+';">' +
			(tt_n4? '&nbsp;' : '')+t_tit+'</font></td></tr>';
	}
