    ...
    public partial class OpenItemDetails : PageBase, System.Web.UI.ICallbackEventHandler
    {
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chk_reassign != null)
                    {
                        ...
                        {
                            chk_reassign.Attributes.Add("onclick", "javascript:line_selected(this," + line_num.ToString() + ");");
                    ...
                    for (var i = 2; i < e.Row.Cells.Count; i++)
                    {
                        ...
                        //{
                        //    e.Row.Cells[i].Attributes.Add("onclick", "javascript:get_line_details('LineNumDetails.aspx?id=" + OItemID.ToString() + "&num=" + line_num.ToString() + "');");
                        //}
                        //else
                        //{
                        //    e.Row.Cells[i].Attributes.Add("onclick", "javascript:get_line_details('OIBA53Review.aspx?id=" + OItemID.ToString() + "&num=" + line_num.ToString() + "');");
                        //}
                        e.Row.Cells[i].Attributes.Add("onclick", "javascript:get_line_details('LineNumDetails.aspx?id=" + OItemID.ToString() + "&num=" + line_num.ToString() + "');");
        ...
        private void LoadFeedbackTable(OpenItem item)
        {
            ...
            else
            {
                ...
                var ds = Item.GetFeedbackRecords(OItemID);
