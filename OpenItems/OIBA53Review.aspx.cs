namespace GSA.OpenItems.Web
{
    ...
    public partial class OIBA53Review : PageBase
    {
        ...
        protected override void PageLoadEvent(object sender, System.EventArgs e)
        {
            ...
            Response.Expires = -1;
            //lblOrgCode.Attributes.Add("style", "display:;");
            ...
            try
            {
                ...
                if (IsPostBack == false)
                {
                    tr_other_reason_for_delay.Attributes.Add("style", "display:none;");
        ...
        private void GetDefaultView()
        {
            try
            {
                div_calc_methodology.Attributes.Add("style", "display:none;");
                div_projected_lease_info.Attributes.Add("style", "display:none;");
                div_breakout_part_year_establ_accr.Attributes.Add("style", "display:none;");
                div_breakout_part_yaer_cost.Attributes.Add("style", "display:none;");
                div_breakout_part_year_RET.Attributes.Add("style", "display:none;");
                div_Reviewer_Reason_Code.Attributes.Add("style", "display:none;");
                tbl_btns.Attributes.Add("style", "display:none;");
                ...
                td_state_1.Attributes.Add("style", "display:none;");
                td_state_2.Attributes.Add("style", "display:none;");

                td_action_1.Attributes.Add("style", "display:none;"); ////
                td_action_2.Attributes.Add("style", "display:none;");////

                div_tr_reason_for_delay.Attributes.Add("style", "display:none;");
        ...
        private void GetViewByAcctType(string sType)
        {
            try
            {
                ...
                div_Reviewer_Reason_Code.Attributes.Add("style", "display:;");
                tbl_btns.Attributes.Add("style", "display:;");
                ...
                switch (sType)
                {
                    case "1": //CPI
                        ddgActionType.SelectedIndex = 0;
                        lblFY_1_EscalationExpenseDiff.Attributes.Add("readOnly", "true");
                        lblFY_1_EscalationExpenseDiff.ToolTip = "";
                        lblFY_1_EscalationExpensePercIncrease.Attributes.Add("readOnly", "true");
                        div_calc_methodology.Attributes.Add("style", "display:;");//
                        tr_lease_eff_date.Attributes.Add("style", "display:;");//
                        tr_proj_no.Attributes.Add("style", "display:none;");//
                        tr_annual_rent.Attributes.Add("style", "display:;");//
                        tr_lease_exp_date.Attributes.Add("style", "display:none;");//
                        tr_lease_ann_date.Attributes.Add("style", "display:none;");//
                        tr_eff_date_action.Attributes.Add("style", "display:none;");// calendar control at cacl. meth section
                        tr_new_proj_ann_rent.Attributes.Add("style", "display:none;");//

                        div_projected_lease_info.Attributes.Add("style", "display:none;");//

                        div_breakout_part_year_establ_accr.Attributes.Add("style", "display:none;");//

                        div_breakout_part_yaer_cost.Attributes.Add("style", "display:;");//
                        tr_FY2.Attributes.Add("style", "display:;");//
                        tr_FY1.Attributes.Add("style", "display:;");//
                        tr_FY.Attributes.Add("style", "display:;");//
                        tr_curr_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_lbl_new_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_old_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_txt_new_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_curr_audit_end_date.Attributes.Add("style", "display:none;");//
                        tr_f_year_end_date.Attributes.Add("style", "display:;");//
                    ...
                    case "2": //EXPANSION
                        ...
                        td_action_1.Attributes.Add("style", "display:;");
                        td_action_2.Attributes.Add("style", "display:;");
                        ...
                        div_calc_methodology.Attributes.Add("style", "display:;");//
                        tr_lease_eff_date.Attributes.Add("style", "display:;");//
                        tr_proj_no.Attributes.Add("style", "display:;");//
                        tr_annual_rent.Attributes.Add("style", "display:;");//
                        tr_lease_exp_date.Attributes.Add("style", "display:none;");//
                        tr_lease_ann_date.Attributes.Add("style", "display:none;");//
                        tr_eff_date_action.Attributes.Add("style", "display:none;");//
                        tr_new_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_proj_no.Attributes.Add("class", "evenTD");
                        ...
                        div_breakout_part_yaer_cost.Attributes.Add("style", "display:;");//
                        tr_FY2.Attributes.Add("style", "display:none;");//
                        tr_FY1.Attributes.Add("style", "display:none;");//
                        tr_FY.Attributes.Add("style", "display:none;");//
                        tr_curr_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_lbl_new_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_old_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_txt_new_proj_ann_rent.Attributes.Add("style", "display:none;");//
                    ...
                    case "3": //HOLDOVER
                        ...
                        tr_proj_no.Attributes.Add("style", "display:none;");//
                        tr_annual_rent.Attributes.Add("style", "display:;");//
                        tr_lease_exp_date.Attributes.Add("style", "display:;");//
                        tr_lease_ann_date.Attributes.Add("style", "display:none;");//
                        tr_eff_date_action.Attributes.Add("style", "display:none;");//
                        tr_new_proj_ann_rent.Attributes.Add("style", "display:none;");//

                        div_projected_lease_info.Attributes.Add("style", "display:;");//

                        div_breakout_part_year_establ_accr.Attributes.Add("style", "display:;");//
                        tr_curr_proj_ann_rent_est.Attributes.Add("style", "display:;");//
                        tr_lbl_new_proj_ann_rent_est.Attributes.Add("style", "display:;");//
                        tr_old_proj_ann_rent_est.Attributes.Add("style", "display:none;");//
                        tr_txt_new_proj_ann_rent_est.Attributes.Add("style", "display:none;");//

                        div_breakout_part_yaer_cost.Attributes.Add("style", "display:;");//
                        tr_FY2.Attributes.Add("style", "display:none;");//
                        tr_FY1.Attributes.Add("style", "display:none;");//
                        tr_FY.Attributes.Add("style", "display:none;");//
                        tr_curr_proj_ann_rent.Attributes.Add("style", "display:;");//

                        tr_lbl_new_proj_ann_rent.Attributes.Add("style", "display:;");//
                        tr_txt_new_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_old_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_curr_audit_end_date.Attributes.Add("style", "display:;");//
                        tr_f_year_end_date.Attributes.Add("style", "display:none;");//
                        div_breakout_part_year_RET.Attributes.Add("style", "display:none;");//
                        lblPartYearCostTitle.Text = "Breakout of Part Year Cost:";
                    ...
                    case "4":  //RET
                        ddgActionType.SelectedIndex = 0;
                        td_state_1.Attributes.Add("style", "display:;");
                        td_state_2.Attributes.Add("style", "display:;");
                        ...
                        div_tr_reason_for_delay.Attributes.Add("style", "display:;");
                        ...
                        {
                            tr_other_reason_for_delay.Attributes.Add("style", "display:;");
                        }
                        else
                        {
                            tr_other_reason_for_delay.Attributes.Add("style", "display:none;");
                        ...
                        div_breakout_part_year_RET.Attributes.Add("style", "display:;");//
                        ...
                        switch (ddgState.ItemID)
                        {
                            case "0":// - select -
                                ...
                                break;
                            case "1": //DC
                                tr_RET_lbl1stHalfTaxInvFY2.Attributes.Add("style", "display:;");
                                tr_RET_1stHalfTaxInvFY1.Attributes.Add("style", "display:;");
                                break;
                            case "2": //MD
                                tr_RET_lbl1stHalfTaxInvFY2.Attributes.Add("style", "display:none;"); //txt1stHalfFY2_TotalTaxBill & txt1stHalfFY2_NoMonthsReimb not visible
                                tr_RET_1stHalfTaxInvFY1.Attributes.Add("style", "display:none;");// txt1stHalfFY1_TotalTaxBill & txt1stHalfFY1_NoMonthsReimb  not visible
                                break;
                            case "3": //VA
                                tr_RET_lbl1stHalfTaxInvFY2.Attributes.Add("style", "display:none;"); //txt1stHalfFY2_TotalTaxBill & txt1stHalfFY2_NoMonthsReimb not visible
                                tr_RET_1stHalfTaxInvFY1.Attributes.Add("style", "display:none;"); // txt1stHalfFY1_TotalTaxBill & txt1stHalfFY1_NoMonthsReimb  not visible
                    ...
                    case "5": //STEP RENT
                        ddgActionType.SelectedIndex = 0;
                        div_calc_methodology.Attributes.Add("style", "display:;");//
                        tr_lease_eff_date.Attributes.Add("style", "display:none;");//
                        tr_proj_no.Attributes.Add("style", "display:;");//
                        tr_annual_rent.Attributes.Add("style", "display:none;");//
                        tr_lease_exp_date.Attributes.Add("style", "display:none;");//
                        tr_lease_ann_date.Attributes.Add("style", "display:none;");//
                        tr_eff_date_action.Attributes.Add("style", "display:;");//
                        tr_new_proj_ann_rent.Attributes.Add("style", "display:;");//

                        div_projected_lease_info.Attributes.Add("style", "display:none;");//

                        div_breakout_part_year_establ_accr.Attributes.Add("style", "display:;");//
                        tr_curr_proj_ann_rent_est.Attributes.Add("style", "display:none;");//
                        tr_lbl_new_proj_ann_rent_est.Attributes.Add("style", "display:none;");//
                        tr_old_proj_ann_rent_est.Attributes.Add("style", "display:;");//
                        tr_txt_new_proj_ann_rent_est.Attributes.Add("style", "display:;");//
                        ...
                        tr_lbl_new_proj_ann_rent.Attributes.Add("style", "display:none;");//
                        tr_txt_new_proj_ann_rent.Attributes.Add("style", "display:;");//

                        tr_old_proj_ann_rent.Attributes.Add("style", "display:;");//
                        tr_txt_new_proj_ann_rent.Attributes.Add("style", "display:;");//
                        tr_curr_audit_end_date.Attributes.Add("style", "display:none;");//
                        div_breakout_part_year_RET.Attributes.Add("style", "display:none;");//
        ...
        private void AddControls(ControlCollection page, ArrayList controlList, bool bDisable, bool bClear)
        {
            foreach (Control c in page)
            {
                if (c.ID != null)
                {
                    ...
                    if (c.GetType().ToString() == "ASP.controls_getdate_ascx")
                    {
                        if (bClear == true)
                        {
                            ((ASP.controls_getdate_ascx)(c)).Clear();
                        }

                        if (bDisable == true)
                        {
                            ((ASP.controls_getdate_ascx)(c)).FreezeMode = true;
                            ((ASP.controls_getdate_ascx)(c)).VoidEdit = true;
                        }
                    }

                    if (c.GetType().ToString() == "ASP.controls_dropdowngrid_ascx")
                    {
                        if (bClear == true)
                        {
                            ((ASP.controls_dropdowngrid_ascx)(c)).SelectedIndex = 0;
                        }

                        if (bDisable == true)
                        {
                            ((ASP.controls_dropdowngrid_ascx)(c)).EnableDropDownGrid(false);
                        }
                    }
            ...
            try
            {
                ...
                if (dr != null)
                {
                        ...
                        User.IsInRole(((int)UserRoles.urReviewer).ToString()) && CurrentItemReviewerID == CurrentUserID))
                    {
                        ...
                        btnSaveFdb.Attributes.Add("onclick", "javascript:save_feedback(this," + load_id + ",'" + ConfigurationManager.AppSettings["FeedbackLoad_DO_UDO_Required"] + "');");

                        if (Boolean.Parse(ConfigurationManager.AppSettings["FeedbackLoad_DO_UDO_Display"]))
                        {
                            ...
                            if (Boolean.Parse(ConfigurationManager.AppSettings["FeedbackLoad_DO_UDO_Required"]))
                            {
        ...
        private string ValidateDropDownGrid(ASP.controls_dropdowngrid_ascx oDDG, string sFieldName, string sError)
        {
        ...
        private string ValidateDropDownGrid_1(ASP.controls_dropdowngrid_ascx oDDG, string sFieldName)
        {
            var sError = "";
        ...
        private string ValidateTextBox(TextBox oTextBox, string sFieldName, string sError)
        {
            if (oTextBox.Text.Trim() == "")
            {
                ...
                //oTextBox.Attributes.Add("style", "background-color:Yellow");
            }
            else
            {
                oTextBox.Attributes.Add("style", "background-color:white");
            }
            return sError;
        }

        private string ValidateCalendarControl(ASP.controls_getdate_ascx oCalendarControl, string sFieldName, string sError)
        {
