    ...
    public partial class Attachments : PageBase
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (CanBeUpdated && Request.QueryString["edit"] != null && Request.QueryString["edit"] != "")
                    {
                        ...
                        btnDelete.AddOnClick("javascript:return delete_att();");
                    }
                    else
        ...
        void gvDocs_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (btnEdit != null)
                    btnEdit.AddOnClick("javascript:return edit_doc(" + doc_id.ToString() + ");");
                ...
                if (DisplaySendProperties)
                {
                    ...
                    if (chkEmail != null)
                    {
                        ...
                        {
                            chkEmail.AddTitle("t1_" + doc_id.ToString());
                            chkEmail.AddOnClick("javascript:include_in_email(this," + doc_id.ToString() + ",'t1_" + doc_id.ToString() + "');");
                    ...
                    if (chkRevEmail != null)
                    {
                        ...
                        {
                            chkRevEmail.AddTitle("t2_" + doc_id.ToString());
                            chkRevEmail.AddOnClick("javascript:include_rev_email(this," + doc_id.ToString() + ",'t2_" + doc_id.ToString() + "');");
                    ...
                    if (chkApproved != null)
                    {
                        ...
                        else
                        {
                            ...
                            chkApproved.AddOnClick("javascript:doc_approved(this," + doc_id.ToString() + "," + doc_type_code + ",'" + doc_type_name + "','" + file_name + "','" + upload_user + "','" + org + "');");
                ...
                e.Row.AddOnMouseOver("javascript:return display_properties(" + row_id.ToString() + ");");
            }
        }
        ...
        private void InitAttachmentsRecommendation()
        {
            ...
            else
            {
                ...
                var recommendedAttachments = Document.RecommendedAttachments(pegasys_doc_type);
                if (!recommendedAttachments.Any())
                {
                ...
                {
                    var firstRecommendedAttachments = recommendedAttachments.First();
                    if (firstRecommendedAttachments.Notes == "")
                        lblPegasysDocTypeNote.Visible = false;
                    else
                    {
                        lblPegasysDocTypeNote.Visible = true;
                        lblPegasysDocTypeNote.Text = "(" + firstRecommendedAttachments.Notes + ")";
                    }
                    lblPegasysDocType.Text = pegasys_doc_type;
                    lblRequiredForTotal.Text = firstRecommendedAttachments.TotalDocTypeDesc;
                    lblRequiredForUDO.Text = firstRecommendedAttachments.DODocTypeDesc;
                }
            }
        }
