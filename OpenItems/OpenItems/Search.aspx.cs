    ...
    public partial class Search : PageBase
    {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkAssign != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                //***SM_
                                chkAssign.AddOnClick("javascript:check_for_assign(this," + intItemID.ToString() + "," + intLineNum.ToString() + ",'" + strULOOrgCode + "');"); txtAllSelected.Value = txtAllSelected.Value + intItemID.ToString() + "_" + intLineNum.ToString() + ",";
                            }
                            else
                                chkAssign.Disabled = true;
                        }
                    ...
                    */
                    ...
                    {
                        e.Row.Cells[i].AddOnClick("javascript:row_on_click(" + intItemID.ToString() + ",'" + strULOOrgCode + "'," + intReviewerUserID.ToString() + "," + intLoadID.ToString() + "," + intLOadType.ToString() + ");");
                    }
                }
            }
            catch (Exception ex)
        ...
        private void BindGridData()
        {
            ...
            if (ItemsDataView != null)
            {
                if (ctrlCriteria.ValHistSearch)
                {
                    excelImage.AddOnClick("window.open('ReportCustom.aspx?id=8');");
                    MergeHeaders();
                    gvItems = gvTest;
                ...
                {
                    excelImage.AddOnClick("window.open('ReportCustom.aspx?id=7');");
                    //ItemsSortExpression = "DocNumber, LoadDate DESC";
                    ...
                    else
                    {
                        ...
                        btnAssign.Visible = false;
                        btnAssign.AddOnClick("javascript:reassign_items();");
