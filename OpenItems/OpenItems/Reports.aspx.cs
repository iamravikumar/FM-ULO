        ...
        protected override void PageLoadEvent(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    btnTotalDaily.AddOnClick("javascript:return get_customized_report(" + ((int)OIReports.rpDaily).ToString() + ");");
                    btnDARA.AddOnClick("javascript:return get_customized_report(" + ((int)OIReports.rpDARA).ToString() + ");");
                    btnDARAByDocNum.AddOnClick("javascript:return get_customized_report(" + ((int)OIReports.rpDaraByDocNum).ToString() + ");");
                    btnCOReport.AddOnClick("javascript:return get_customized_report(" + ((int)OIReports.rpCOTotal).ToString() + ");");
                    btnTotalUniverse.AddOnClick("javascript:return get_customized_report(" + ((int)OIReports.rpUniversityTotal).ToString() + ");");
                    btnDocuments.AddOnClick("javascript:return get_customized_report(" + ((int)OIReports.rpDocuments).ToString() + ");");
                    btnValidationByLine.AddOnClick("javascript:return get_customized_report(" + ((int)OIReports.rpValidationByLine).ToString() + ");");
                }
