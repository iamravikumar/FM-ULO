            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (chkDeobligate != null)
                {
                    if (ctrlCriteria.LoadIsArchived ||
                        ...
                        chkDeobligate.Attributes.Add("onclick", "javascript:return on_certify(this," + intItemID.ToString() + "," + intLineN.ToString() + ",'" + strOrgCode + "');");
                ...
                {
                    if (i != 6)
                        e.Row.Cells[i].Attributes.Add("onclick", "javascript:window.location.href='OpenItemDetails.aspx?id=" + intItemID.ToString() + "&org=" + strOrgCode + "&user=" + intReviewerUserID.ToString() + "';");
                }
            }
        }
