            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                    ...
                    else
                    {
                            ...
                            User.IsInRole(((int)UserRoles.urOrganizationAdmin).ToString()))
                        {
                            if (intCurrentReviewer != 0 && intItemStatus == (int)OpenItemStatus.stNewItem &&
                                ...
                                chkVerify.Attributes.Add("onclick", "javascript:on_verify(this, " + intItemID.ToString() + ", '" + strOrgCode + "'," + intCurrentReviewer.ToString() + ");");
                            else
                                chkVerify.Disabled = true;
                        }
                        else
                ...
                if (btnAssign != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            btnAssign.Attributes.Add("onclick", "javascript:reassign_item(this," + intItemID.ToString() + ",'" + strDocNumber + "','" + strOrgCode + "'," + intCurrentReviewer.ToString() + ");");
                        }
                        else
                            btnAssign.Disabled = true;
                    }
                ...
                for (var i = 0; i < e.Row.Cells.Count; i++)
                {
                    if (i != 8 && i != 9)
                        ...
                        e.Row.Cells[i].Attributes.Add("onclick", "javascript:row_on_click(this,'" + strItemPage + "'," + intItemID.ToString() + ",'" + strOrgCode + "'," + intCurrentReviewer.ToString() + "," + iLoadID.ToString() + ");");
                    if (i == 6)
                    {
