            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (chkVerify != null)
                {
                    if (intRerouteUserID == 0 ||
                        ...
                        chkVerify.Attributes.Add("onclick", "javascript:on_verify(this," + intRequestID.ToString() + "," + intRerouteUserID.ToString() + ",'" + strPrevOrgDesc + "'," + intPrevReviewerUserID.ToString() + ");");
                }
                ...
                if (btnAssign != null)
                {
                    if (!User.IsInRole(((int)UserRoles.urBudgetDivisionAdmin).ToString()) &&
                        ...
                        btnAssign.Attributes.Add("onclick", "javascript:reassign_item(this," + intRequestID.ToString() + ");");
                }
                ...
                {
                    if (i != 9 && i != 10)
                        e.Row.Cells[i].Attributes.Add("onclick", "javascript:window.location.href='OpenItemDetails.aspx?id=" + intItemID.ToString() + "&org=" + strOrgCode + "&user=" + intPrevReviewerUserID.ToString() + "';");
                }
            }
        }
