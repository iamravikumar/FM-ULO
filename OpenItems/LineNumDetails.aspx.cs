    ...
    public partial class LineNumDetails : PageBase
    {
        ...
        private void InitControls(bool ItemIsArchived)
        {
            ...
            foreach (ListItem li in rblJustification.Items)
            {
                ...
                //li.Attributes.Add("onclick", "javascript:rbl_display_Just_explanation('" + li.Value + "')");
                li.Attributes.Add("onclick", "javascript:rbl_display_Just_explanation('" + j_id + "')");
            }
        ...
        private void LoadLineNumDetails(LineNum line_item, bool EnableForUpdate, bool IsArchived)
        {
            ...
            if (dr.Length > 0)
            {
                if ((bool)dr[0]["InDefaultList"])
                {
                    ...
                    {
                        lblJustificationExplanation.Attributes.Add("style", "visibility:hidden;");
                        txtAddJustification.Attributes.Add("style", "visibility:hidden;");
                        lblJustAddInfo.Attributes.Add("style", "visibility:hidden;");
                    }
                    txtJustOther.Attributes.Add("style", "visibility:hidden;");
                    lblJustOther.Attributes.Add("style", "visibility:hidden;");
                }
                else
                {
