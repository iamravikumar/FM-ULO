namespace GSA.OpenItems.Web
{
    ...
    public partial class ReportCustom : PageBase
    {
        ...
        private void BuildDARAReportForSample(DataTable dtTotal, DataTable dtSent, int LoadID)
        {
            ...
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("DARA", "label"));
            ...
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Total For Review", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("Sent to Central Office", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("Pending", "titleBoldNavy"));
            Sheet.Rows.Add(objRow);
            excelRow++;
            ...
            foreach (XmlNode node in doc.DocumentElement.ChildNodes)
            {
                ...
                objRow = new HtmlTableRow();
                objRow.Cells.Add(CreateCell("", ""));
                objRow.Cells.Add(CreateCell(node.Attributes.GetNamedItem("name").Value, "titleBoldNavy"));
                CompleteExcelRow(ref objRow, max_columns);
                Sheet.Rows.Add(objRow);
                excelRow++;
                ...
                foreach (XmlNode child_node in node.ChildNodes)
                {
                    ...
                    objRow = new HtmlTableRow();
                    objRow.Cells.Add(CreateCell(org_symbol, "textLeft"));
                    objRow.Cells.Add(CreateCell(child_node.Attributes.GetNamedItem("division").Value, "textLeft"));
                    ...
                    if (dr.Length > 0)
                        ...
                        total_count = 0;
                    objRow.Cells.Add(CreateCell(total_count.ToString(), "WholeNumber"));
                    ...
                    if (dr.Length > 0)
                        ...
                        sent_count = 0;
                    objRow.Cells.Add(CreateCell(sent_count.ToString(), "WholeNumber"));

                    //add pending doc numbers amount:    
                    pending = total_count - sent_count;
                    objRow.Cells.Add(CreateCell(pending.ToString(), "WholeNumber"));
                ...
                objRow = new HtmlTableRow();
                objRow.Cells.Add(CreateCell("", ""));
                objRow.Cells.Add(CreateCell("Total", "textBoldBlack"));
                if (finish_count_row >= start_count_row)
                {
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(C{0}:C{1})", start_count_row, finish_count_row), "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(D{0}:D{1})", start_count_row, finish_count_row), "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(E{0}:E{1})", start_count_row, finish_count_row), "WholeNumberBold"));
                }
                else
                {
                    objRow.Cells.Add(CreateCell("0", "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell("0", "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell("0", "WholeNumberBold"));
                }
                Sheet.Rows.Add(objRow);
            ...
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Total Count", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("C", total_rows), "WholeNumberBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("D", total_rows), "WholeNumberBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("E", total_rows), "WholeNumberBold"));
            Sheet.Rows.Add(objRow);
        }
        ...
        private void BuildDARAReport(DataTable dtTotal, bool DARAByDoc)
        {
            ...
            if (DARAByDoc)
            {
                objRow.Cells.Add(CreateCell("DARA by DocNum", "label"));
            }
            else
            {
                objRow.Cells.Add(CreateCell("DARA", "label"));
            ...
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Invalid", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Valid", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Total Reviewed", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Pending", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Total", "titleBoldNavy"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            excelRow++;
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Invalid # Records", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Invalid $ Value", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Valid # Records", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Valid $ Value", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Total Reviewed # Records", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("Total Reviewed $ Value", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("Pending # Records", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Pending $ Value", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Total # Records", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell("Total $ Value", "titleBoldNavy"));
            Sheet.Rows.Add(objRow);
            excelRow++;
            ...
            foreach (XmlNode node in doc.DocumentElement.ChildNodes)
            {
                ...
                foreach (XmlNode child_node in node.ChildNodes)
                {
                    ...
                    objRow.Cells.Add(CreateCell(records_count, "WholeNumber"));
                    objRow.Cells.Add(CreateCell(money_value, "Money"));
                    ...
                    objRow.Cells.Add(CreateCell(s_value, "WholeNumber"));
                    //add total reviewed value:
                    s_value = String.Format("=SUM(D{0},F{0})", excelRow);
                    objRow.Cells.Add(CreateCell(s_value, "Money"));
                ...
                {
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(C{0}:C{1})", start_count_row, finish_count_row), "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(D{0}:D{1})", start_count_row, finish_count_row), "MoneyBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(E{0}:E{1})", start_count_row, finish_count_row), "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(F{0}:F{1})", start_count_row, finish_count_row), "MoneyBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(G{0}:G{1})", start_count_row, finish_count_row), "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(H{0}:H{1})", start_count_row, finish_count_row), "MoneyBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(I{0}:I{1})", start_count_row, finish_count_row), "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(J{0}:J{1})", start_count_row, finish_count_row), "MoneyBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(K{0}:K{1})", start_count_row, finish_count_row), "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell(String.Format("=SUM(L{0}:L{1})", start_count_row, finish_count_row), "MoneyBold"));
                }
                else
                {
                    objRow.Cells.Add(CreateCell("0", "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell("0", "MoneyBold"));
                    objRow.Cells.Add(CreateCell("0", "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell("0", "MoneyBold"));
                    objRow.Cells.Add(CreateCell("0", "WholeNumberBold"));
                    objRow.Cells.Add(CreateCell("0", "MoneyBold"));
            ...
            objRow.Cells.Add(CreateCell("Total Records", "titleBoldNavy"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("C", total_rows), "WholeNumberBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("D", total_rows), "MoneyBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("E", total_rows), "WholeNumberBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("F", total_rows), "MoneyBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("G", total_rows), "WholeNumberBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("H", total_rows), "MoneyBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("I", total_rows), "WholeNumberBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("J", total_rows), "MoneyBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("K", total_rows), "WholeNumberBold"));
            objRow.Cells.Add(CreateCell(MakeSumSentence("L", total_rows), "MoneyBold"));
            Sheet.Rows.Add(objRow);
        }
        ...
        private void BuildTotalUniverseReport(DataTable dtTotal, DataTable dtTotalByValid, DataTable dtDeobligated, int LoadID)
        {
            ...
            objRow.Cells.Add(CreateCell(s_msg, "titleBoldNavy"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            ...
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Type:", "textBoldBlack"));
            objRow.Cells.Add(CreateCell((string)Utility.GetNotNullValue(dr["OITypeDescription"], "String"), "textLeft"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Source:", "textBoldBlack"));
            objRow.Cells.Add(CreateCell(dr["DataSourceDescription"].ToString(), "textLeft"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("ULO Load Date:", "textBoldBlack"));
            objRow.Cells.Add(CreateCell(((DateTime)dr["LoadDate"]).ToString("MMM dd, yyyy"), "textLeft"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            ...
            //total records:
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Total Records", "textBoldBlack"));
            objRow.Cells.Add(CreateCell(dtTotal.Rows[0]["TotalCount"].ToString(), "WholeNumberBold"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Total Dollar Amt $", "textBoldBlack"));
            objRow.Cells.Add(CreateCell(dtTotal.Rows[0]["TotalSum"].ToString(), "MoneyBold"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            ...
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Status", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Records", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Dollar Value", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("% Dollar Value Researched", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("% Total Records", "textBoldBlack"));
            Sheet.Rows.Add(objRow);
            ...
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Valid", "textLeft"));
            objRow.Cells.Add(CreateCell(records, "WholeNumber"));
            objRow.Cells.Add(CreateCell(total_value, "Money"));
            objRow.Cells.Add(CreateCell("=C11/B7", "Percent"));
            objRow.Cells.Add(CreateCell("=B11/B6", "Percent"));
            Sheet.Rows.Add(objRow);
            ...
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Invalid", "textLeft"));
            objRow.Cells.Add(CreateCell(records, "WholeNumber"));
            objRow.Cells.Add(CreateCell(total_value, "Money"));
            objRow.Cells.Add(CreateCell("=C12/B7", "Percent"));
            objRow.Cells.Add(CreateCell("=B12/B6", "Percent"));
            Sheet.Rows.Add(objRow);

            //for Total reviewed:
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Total Reviewed", "textLeft"));
            objRow.Cells.Add(CreateCell("=B11+B12", "WholeNumber"));
            objRow.Cells.Add(CreateCell("=C11+C12", "Money"));
            objRow.Cells.Add(CreateCell("=C13/B7", "Percent"));
            objRow.Cells.Add(CreateCell("=B13/B6", "Percent"));
            Sheet.Rows.Add(objRow);
            ...
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Needing Review", "textLeft"));
            objRow.Cells.Add(CreateCell(records, "WholeNumber"));
            objRow.Cells.Add(CreateCell(total_value, "Money"));
            objRow.Cells.Add(CreateCell("=C14/B7", "Percent"));
            objRow.Cells.Add(CreateCell("=B14/B6", "Percent"));
            Sheet.Rows.Add(objRow);

            //for Total summary:
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Total", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("=SUM(B11,B12,B14)", "WholeNumberBold"));
            objRow.Cells.Add(CreateCell("=SUM(C11,C12,C14)", "MoneyBold"));
            objRow.Cells.Add(CreateCell("=SUM(D11,D12,D14)", "PercentBold"));
            objRow.Cells.Add(CreateCell("=SUM(E11,E12,E14)", "PercentBold"));
            Sheet.Rows.Add(objRow);
            ...
            if (display_deobligated)
            {
                ...
                objRow = new HtmlTableRow();
                objRow.Cells.Add(CreateCell("Total Records Deobligated", "textLeft"));
                objRow.Cells.Add(CreateCell(dtDeobligated.Rows[0]["RecordsCount"].ToString(), "WholeNumber"));
                CompleteExcelRow(ref objRow, max_columns);
                Sheet.Rows.Add(objRow);
                objRow = new HtmlTableRow();
                objRow.Cells.Add(CreateCell("Total Dollar Amt $", "textLeft"));
                objRow.Cells.Add(CreateCell(dtDeobligated.Rows[0]["TotalSum"].ToString(), "Money"));
                CompleteExcelRow(ref objRow, max_columns);
                Sheet.Rows.Add(objRow);
                ...
                objRow = new HtmlTableRow();
                objRow.Cells.Add(CreateCell("Records Pending Deobligation", "textLeft"));
                objRow.Cells.Add(CreateCell("=B12-B18", "WholeNumber"));
                CompleteExcelRow(ref objRow, max_columns);
                Sheet.Rows.Add(objRow);
                objRow = new HtmlTableRow();
                objRow.Cells.Add(CreateCell("Total Dollar Amt $", "textLeft"));
                objRow.Cells.Add(CreateCell("=C12-B19", "Money"));
                CompleteExcelRow(ref objRow, max_columns);
                Sheet.Rows.Add(objRow);
            ...
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("As of ", "textBoldBlack"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Region Wide OI Records", "textLeft"));
            CompleteExcelRow(ref objRow, max_columns);
            Sheet.Rows.Add(objRow);
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Total Dollar Amt $", "textLeft"));
        ...
        private void BuildValHistorySearchReport(DataTable dtSearch)
        {
            ...
            for (var p = 0; p < dtSearch.Rows.Count; p++)
            {
                ...
                {
                    objRow.Cells.Add(CreateCell(dtSearch.Rows[p][q].ToString(), "textLeft"));
                }
        ...
        private void BuildDailyReport(DataTable dtTotal, DataTable dtDeobligated, int LoadID)
        {
            ...
            objRow = new HtmlTableRow();
            objRow.Cells.Add(CreateCell("Off Code", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Off. Symb.", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Division", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Invalid", "textBoldBlack"));
            if (display_deobligated)
                objRow.Cells.Add(CreateCell("Deobligated (included in Invalid)", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Invalid $ Value", "textBoldBlack"));
            if (display_deobligated)
                objRow.Cells.Add(CreateCell("Deobligated$ Value (included in Invalid)", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Valid", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Valid $ Value", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Pending", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Pending $ Value", "textBoldBlack"));
            objRow.Cells.Add(CreateCell("Records", "textBoldBlack"));
            Sheet.Rows.Add(objRow);
            excelRow++;
            ...
            for (var i = 0; i < dtTotal.Rows.Count;)
            {
                ...
                objRow = new HtmlTableRow();
                objRow.Cells.Add(CreateCell(sOrg, "textLeft"));
                objRow.Cells.Add(CreateCell(sOrgSymbol, "textLeft"));
                objRow.Cells.Add(CreateCell(sDivision, "textLeft"));

                objRow.Cells.Add(CreateCell(count_invalid.ToString(), "WholeNumber"));
                if (display_deobligated)
                    objRow.Cells.Add(CreateCell(count_deobl.ToString(), "WholeNumber"));
                objRow.Cells.Add(CreateCell(total_invalid.ToString(), "Money"));
                if (display_deobligated)
                    objRow.Cells.Add(CreateCell(total_deobl.ToString(), "Money"));
                objRow.Cells.Add(CreateCell(count_valid.ToString(), "WholeNumber"));
                objRow.Cells.Add(CreateCell(total_valid.ToString(), "Money"));
                objRow.Cells.Add(CreateCell(count_pend.ToString(), "WholeNumber"));
                objRow.Cells.Add(CreateCell(total_pend.ToString(), "Money"));

                if (display_deobligated)
                    s_msg = String.Format("=SUM(D{0},H{0},J{0})", excelRow);
                else
                    s_msg = String.Format("=SUM(D{0},F{0},H{0})", excelRow);
                objRow.Cells.Add(CreateCell(s_msg, "WholeNumber"));
                Sheet.Rows.Add(objRow);
                excelRow++;
            }
            ...
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("", ""));
            objRow.Cells.Add(CreateCell("Grand Total", "textBoldBlack"));
            if (display_deobligated)
            {
                objRow.Cells.Add(CreateCell(String.Format("=SUM(D{0}:D{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(E{0}:E{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(F{0}:F{1})", table_row_start, excelRow - 1), "MoneyBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(G{0}:G{1})", table_row_start, excelRow - 1), "MoneyBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(H{0}:H{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(I{0}:I{1})", table_row_start, excelRow - 1), "MoneyBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(J{0}:J{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(K{0}:K{1})", table_row_start, excelRow - 1), "MoneyBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(L{0}:L{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
            }
            else
            {
                objRow.Cells.Add(CreateCell(String.Format("=SUM(D{0}:D{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(E{0}:E{1})", table_row_start, excelRow - 1), "MoneyBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(F{0}:F{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(G{0}:G{1})", table_row_start, excelRow - 1), "MoneyBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(H{0}:H{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(I{0}:I{1})", table_row_start, excelRow - 1), "MoneyBold"));
                objRow.Cells.Add(CreateCell(String.Format("=SUM(J{0}:J{1})", table_row_start, excelRow - 1), "WholeNumberBold"));
        ...
        public void BuildGeneralExcelOutput(DataTable dt)
        {
            ...
            for (var i = 0; i < dt.Columns.Count; i++)
                objRow.Cells.Add(CreateCell(dt.Columns[i].ToString(), "titleBoldNavy"));
