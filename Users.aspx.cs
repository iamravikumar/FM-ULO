    ...
    public partial class Users : PageBase 
    {
        ...
        protected override void PageLoadEvent(object sender, System.EventArgs e)
        {
            ...
            if (IsPostBack == false)
            {
                ...
                txtFirstName.Attributes.Add("onkeydown", "event.returnValue=false;");
                txtLastName.Attributes.Add("onkeydown", "event.returnValue=false;");
                txtMI.Attributes.Add("onkeydown", "event.returnValue=false;");
                txtEmail.Attributes.Add("onkeydown", "event.returnValue=false;");
                ...
                try
                {
                    ...
                    if (Request.QueryString["mode"] == "pswd")
                    {
                        ...
                        if (iUserID != 0)
                        {
                            ...
                            tr_user_role.Attributes.Add("style", "display:none");
        ...
        protected void rbListNewOld_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (rbListNewOld.SelectedIndex == 0) // new user
            {
                ...
                txtEmail.ToolTip = "read-only field";
                tr_user.Attributes.Add("style", "display:");
            ...
            {
                FillControls(1);
                txtFirstName.Attributes.Add("onkeydown", "event.returnValue=true;");
                txtLastName.Attributes.Add("onkeydown", "event.returnValue=true;");
                txtMI.Attributes.Add("onkeydown", "event.returnValue=true;");
                txtEmail.Attributes.Add("onkeydown", "event.returnValue=true;");
                ...
                tr_user.Attributes.Add("style", "display:none");
                //tr_user.Visible = false;
            }
