        ...
        public void DrawDistributionTable()
        {
            ...
            foreach (DataRow drConfig in ds.Tables[0].Rows)
            {
                ...
                if ((int)drConfig["GROUP_CD"] != 0)
                {
                    ...
                    tr.Cells.Add(CreateCell(row_name, "reportCaption"));
                    ...
                    td.Controls.Add(txt);
                    txt.Attributes.Add("style", "width:90px;height:15px;text-align:right");
                    if (!ReadOnly)
                    {
                        txt.Attributes.Add("onmouseout", "extractNumber(this,0,false,0);");
                        txt.Attributes.Add("onkeyup", "extractNumber(this,0,false,0);");
