namespace GSA.OpenItems.Web
{
    ...
    public class FundStatusBO
    {
        ...
        public DataSet GetBAList()
        {
            return Dal.GetBALList();
        }

        public DataSet GetOrganizationList()
        {
            //olga 07/26/10
            return Dal.GetFundsOrganizations();
        }
        ...
        public DataSet GetSummaryFunctionsList()
        {
            return Dal.GetFundsSumFunctionList();
        }

        public DataSet GetAllFunctionCodeList()
        {
            return Dal.GetFundsAllFunctionList();
        }

        public DataSet GetObjectClassCodeList()
        {
            return Dal.GetObjectClassCodeList();
        }

        public DataSet GetCostElemList()
        {
            return Dal.GetCostElementList();
        }

        public DataSet GetBusinessLineList()
        {
            //olga 07/26/10
            return Dal.GetBusinessLineList();
        }
       ...
       public DataSet GetSearchResults(int iFundsViewMode, string sFiscalYear, string sBudgetActivity, out int iRecordsCount, out decimal dTotalAmount,
        ...
        public bool UpdateRWAProjection(string sFiscalYear, string sStartBookMonth, string sOrgCode, string sProjectionArray, int iUpdateUserID)
        {
            bool return_result;
            /**********************************************************************************************************/
            var conn = new SqlConnection(ConfigurationSettings.AppSettings["DefaultConn"]);
            conn.Open();
            /*** begin transaction ***/
