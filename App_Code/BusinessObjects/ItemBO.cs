namespace GSA.OpenItems.Web
{
    ...
    public class ItemBO
    {
        ...
        public DataSet GetDocNumByItemID(int iOItemID)
        {
            return Dal.GetDocNumByItemID(iOItemID);
        }

        public DataSet GetFeedbackRecords(int iOItemID)
        {
            return Dal.GetOIFeedbackDetails(iOItemID);
        }
