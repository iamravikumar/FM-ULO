    ...
    public class UsersBO
    {
        ...
        public void AuthenticateAfterLDAP(string sEmail, string sUserName, out string sUserID)
        {
            ...
            if (ds.Tables[0].Rows.Count == 0)
            {
                ...
                var sSysAdminEmail = ConfigurationManager.AppSettings["SysAdminEmail"];
                var sULOSystemEmail = ConfigurationManager.AppSettings["MailSenderAddress"];
                if (Boolean.Parse(ConfigurationManager.AppSettings["SendEmailToSysAdmin"]))
                {
            ...
            var sSysAdminRoleCode = ConfigurationManager.AppSettings["SysAdminRoleCode"];
            ...
            _pageBase.CurrentUserID = intUserID;
            _pageBase.CurrentUserName = strUserFullName;
            _pageBase.CurrentUserLogin = sUserName;
            _pageBase.CurrentUserRoles = strRoles;
            _pageBase.CurrentUserOrganization = strUserOrganization;
            _pageBase.CurrentUserDefaultApp = defaultApplication;
        }
