...
namespace GSA.OpenItems.Web
{
    ...
    public class AssignBO
    {
        ...
        public void VerifyAssignment(int OItemID, int LoadID, string OrgCode, int ReviewerUserID)
        {
            ...
            if (Boolean.Parse(ConfigurationSettings.AppSettings["WriteExtendedLog"]))
            {
        ...
        public int VerifyReroute(int RequestID)
        {
            ...
            var return_code = Dal.VerifyItemReroute(RequestID, OpenItemStatus.stAssigned, ParameterDirection.Output);
            ...
            string sResponsibleOrg, string sNewOrganization, string sNewOrgCode, int iNewReviewerUserID, string sComments)
        {
            ...
            var conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConn"].ConnectionString);                
            conn.Open();
            /*** begin transaction ***/
            ...
            try
            {
                ...
                foreach (var line_num in arr_lines)
                {
                    ...
                    return_value = (int)Dal.RequestRerouteItem(iOItemID, ULOOrgCode, Convert.ToInt32(line_num), ReviewerUserID, sResponsibleOrg, sNewOrganization, sNewOrgCode, iNewReviewerUserID, sComments, OpenItemStatus.stReassignRequest, trans, conn);
            ...
            string sNewOrganization, string sNewOrgCode, int iNewReviewerID, string sComments)
        {
            ...
            try
            {
                ...
                foreach (var line_num in arr_lines)
                {
                    ...
                    return_code = (int)Dal.RerouteItem(iOItemID, Convert.ToInt32(line_num), ReviewUser, ULOOrgCode, sNewOrganization, sNewOrgCode, iNewReviewerID, sComments, trans, conn);
        ...
        public int RerouteItem(int iRequestID, string sNewOrganization, string sNewOrgCode, int iNewReviewerUserID, string sComments)
        {
            ...
            try
            {
                ...
                return_code = (int)Dal.RerouteItemByRequest(iRequestID, sNewOrganization, sNewOrgCode, iNewReviewerUserID, sComments, trans, conn);
        ...
        public DataSet GetOrganizationsList()
        {
            var ds = Dal.GetReassignOrgList();
