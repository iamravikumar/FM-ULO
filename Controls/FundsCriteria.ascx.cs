namespace GSA.OpenItems.Web
{
    ...
    public partial class Controls_FundsCriteria : System.Web.UI.UserControl
    {
        ...
        private readonly FundStatusBO FundStatus = new FundStatusBO(new DataLayer(new zoneFinder()));
        ...
        private void DisplaySelectedCriteriaFromStorage()
        {
            if (CriteriaStorage != null)
            {
                ...
                if (ParentScreenURL != "")
                {
                    ...
                    btnBack.Attributes.Add("onclick", "javascript:return search_go_back('" + ParentScreenURL + "');");
                    RegisterSearchBackScript();
                }
            }
        ...
        public void InitControls()
        {
            ...
            ds = FundStatus.GetBusinessLineList();
            if (ds == null || ds.Tables[0].Rows.Count == 0)
            ...
            if (ScreenType == (int)FundsStatusScreenType.stFundsSearch)
            {
                ...
                ds = FundStatus.GetSummaryFunctionsList();
                ...
                ds = FundStatus.GetObjectClassCodeList();
                dr = ds.Tables[0].NewRow();
                dr["OBJ_CLASS_CD"] = "";
                dr["OC_DESC"] = "";
                ds.Tables[0].Rows.InsertAt(dr, 0);
            ...
            btnExcel.Attributes.Add("onclick", "javascript:return funds_data_to_excel(" + ScreenType.ToString() + ");");
        ...
        public void AllowReturnBack(string ReturnURL)
        {
            ...
            btnBack.Visible = true;
            btnBack.Attributes.Add("onclick", "javascript:return search_go_back('" + ReturnURL + "');");
        ...
        //{
        //    set { btnExcel.Attributes.Add("onclick", "javascript:return " + value + ";"); }
        //}

        //public string RequestEmailClientFunction
        //{
        //    set { btnEmail.Attributes.Add("onclick", "javascript:return " + value + ";"); }
        //}
