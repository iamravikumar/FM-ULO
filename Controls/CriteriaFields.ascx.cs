    ...
    public partial class Controls_CriteriaFields : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (IsPostBack)
                {
                    txtLoadTypeID.Attributes.Add("style", "display:none;");
        ...
        private bool DisplayArchive
        {
            get
            {
                if (ViewState["DisplayArchive"] != null)
                    ...
                    return Boolean.Parse(ConfigurationManager.AppSettings["DisplayArchiveOption"]);
            }
            set
            {
                ViewState["DisplayArchive"] = value && Boolean.Parse(ConfigurationManager.AppSettings["DisplayArchiveOption"]);
            }
        }
