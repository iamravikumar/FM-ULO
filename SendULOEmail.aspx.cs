    ...
    public partial class SendULOEmail : PageBase
    {
        ...
        protected override void PageLoadEvent(object sender, System.EventArgs e)
        {
            ...
            if (IsPostBack == false)
            {
                ...
                //txtSendTo.Attributes.Add("onkeydown", "event.returnValue=false;");
        ...
        protected void ddlRecipients_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                tr_custom_email_1.Attributes.Add("style", "display:");
                tr_custom_email_2.Attributes.Add("style", "display:");
            }
            else
            {
                tr_custom_email_1.Attributes.Add("style", "display:none");
                tr_custom_email_2.Attributes.Add("style", "display:none");
                txtSendTo.Text = "";
            } 
